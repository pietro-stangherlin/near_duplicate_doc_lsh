...
# PATHS ------------------------------------------------
ORIGINAL_PATH = "data_near_duplicate\\robust\\robust_id2.json"

MINHASH_PARAMS_FOLDER = "near_duplicate_doc_lsh\\real_data_scripts\\robust\\minhash_params\\"
...
MINHASH_SIGNATURE_DB_DUPLICATES_DONE_FOLDERS_NAMES_FILE = "near_duplicate_doc_lsh\\real_data_scripts\\robust\\already_done\\signature_db_duplicates_done_names.txt"

# Lsh ------------------
LSH_PARAMS_FOLDER = "near_duplicate_doc_lsh\\real_data_scripts\\robust\\lsh_params\\"

# each line is a name of already done
# lsh result folder
LSH_RESULT_DONE_FOLDERS_NAMES_FILE = "near_duplicate_doc_lsh\\real_data_scripts\\robust\\already_done\\lsh_names_result_done.txt"

# final results
LSH_RESULTS_FOLDER = "data_near_duplicate\\robust\\lsh_results\\"

# (Only) Duplicates collections folder path
ONLY_DUPLICATES_COLLECTION_FOLDER_PATH = "data_near_duplicate\\robust\\clones\\"
