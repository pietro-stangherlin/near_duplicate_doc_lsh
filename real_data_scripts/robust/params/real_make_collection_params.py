...
from near_duplicate_doc_lsh.real_data_scripts.robust.params import parameters as pm


clones_path = pm.ONLY_DUPLICATES_COLLECTION_FOLDER_PATH

# per_centace on total number of duplicates
