...
# NOTE: there are two version of ComputeHashValues and GenerateSignature:
# plain versions accept a list of hash_function as parameters
# the V2 versions accept instead a general hash_function 
# and a list of list of its parameters other than the argument to be hashed
# V2 are preferred as they should work with other hash functions defined in the hash.py file
